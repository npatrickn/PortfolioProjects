...
from PortfolioProject..sales_data_sample
where YEAR_ID = 2003 --change year to  reset.
group by  MONTH_ID
order by 2 desc



--November seems to be the best selling month, what product do they sell in November
...
--select * from PortfolioProject..sales_data_sample where ORDERNUMBER =  10411
